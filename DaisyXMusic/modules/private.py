    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="Open Private", url=f"https://t.me/Lisatelebot?start"
                    )
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            [InlineKeyboardButton("➕ Add me to your Group 🙋‍♀️", url=f"https://t.me/Lisatelebot?startgroup=true")],
            [InlineKeyboardButton(text = '🛠 Source Code 🛠', url=f"https://t.me/marvelmoviesstuff")],
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🟡 Click here for help 🟡", url=f"https://t.me/Lisatelebot?start"
                    )
                ]
            ]
        ),
